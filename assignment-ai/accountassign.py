...
from aamodel import AA4Model,train_model, test_model
...
##########################
def create_model(X, Xdetails, label_data, device) :
  ...
  model = AA4Model(input_size,NUM_CATEGORIES)
  model.to(device)
  ...
  return test_model( model, Xtest, Xdetailstrain, yabs, device )
...
#device = getDevice()
#X1 = createInputArray(X)
#total, correct = create_model(X1,XDetails, y,device)
