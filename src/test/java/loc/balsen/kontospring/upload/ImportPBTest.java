...
public class ImportPBTest {
	...
	public void testInsertTwice() throws ParseException, IOException {
		...
		when(accountRecordRepository.findByValueAndCreatedAndSenderAndReceiver(eq(-4280), any(LocalDate.class), any(String.class), any(String.class))).thenReturn(recordList );
